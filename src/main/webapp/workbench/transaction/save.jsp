...
<body>
	...
	<form action="workbench/transaction/save.do" id="tranForm" method="post" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" value="十天搞定CRM冲" id="create-activitySrc" name="activityId">
				<input type="hidden" value="f7ec5b4787ac47c2b52e876c3e575fb5" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="c33c4989031a410687fd295f196c7d27" name="contactsId"/>
			</div>
		</div>
